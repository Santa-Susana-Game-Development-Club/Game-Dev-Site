            ...
            <div class="row">
                <div class="container">
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <h1>Salaries <small><a href="http://www.gamasutra.com/view/news/221533/Game_Developer_Salary_Survey_2014_The_results_are_in.php" target="_blank">Source</a></small></h1>
                        <ul>
                            <li>Business and management: $101,572</li>
                            <li>Audio professionals: $95,682</li>
                            <li>Programmers: $93,251</li>
                            <li>Artists and animators: $74,349</li>
                            <li>Producers: $82,286</li>
                            <li>Game designers: $73,864</li>
                            <li>Quality Assurance: $54,833</li>
                        </ul>
                        ...
                        <a href="http://www.worldwidestudios.net/santamonica" target="_blank"><img src="http://img1.wikia.nocookie.net/__cb20130719183823/logopedia/images/6/69/Santa_Monica_Studio.png" alt="Santa Monica Studios" class="img-responsive gamec" id="half" /></a>
